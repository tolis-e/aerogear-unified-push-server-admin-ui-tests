...
The container's configuration resides in the [Arquillian XML](https://github.com/tolis-e/aerogear-unified-push-server-admin-ui-tests/blob/master/src/test/resources/arquillian.xml) configuration file while the deployment and the archive are defined in the [Deployments](https://github.com/tolis-e/aerogear-unified-push-server-admin-ui-tests/blob/master/src/test/java/org/jboss/aerogear/unifiedpush/admin/ui/test/Deployments.java) file.
